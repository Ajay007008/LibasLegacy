    ...
    <div className="max-w-screen-xl mx-auto px-4 py-16">
      ...
      <div className="grid md:grid-cols-3 gap-8 items-stretch">
        ...
        <div className="flex flex-col h-full">
          <img src={img1} alt="Mens Bespoke Suits" className="w-full h-[450px] object-contain" />
        ...
        {/* Card 2 */}
        <div className="flex flex-col h-full">
          <img src={img2} alt="Ladies Bespoke Suits" className="w-full h-[450px] object-contain" />
          <div className="flex flex-col flex-grow mt-6">
        ...
        {/* Card 3 */}
        <div className="flex flex-col h-full">
          <img src={img3} alt="Remote Suit Service" className="w-full h-[450px] object-contain" />
          <div className="flex flex-col flex-grow mt-6">
            <h3 className="text-lg font-medium mb-2">Remote Suit Service</h3>
            <p className="text-sm text-gray-600 mb-4 flex-grow">
              With decades of expertise, Des Merrion offers a superior experience for those seeking bespoke garments but unable to visit in person. Our remote suit service is tailored to meet your unique style needs and preferences.
            </p>
            <button className="text-xs uppercase tracking-widest border-b border-black hover:text-[#820D23] transition self-start">
