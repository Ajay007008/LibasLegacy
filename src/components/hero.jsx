    ...
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
      ...
      <div className="relative w-full md:w-1/2 flex justify-center">
          <div className="relative">
            <img src={img2} alt="Suit" className="w-64 h-85 rounded shadow-lg" />
            <img src={img1} alt="Tailor" className="w-56 rounded shadow-lg absolute -bottom-20 -left-20"/>
          </div>
        </div>
      ...
      <div className="w-full md:w-1/2">
        <h2 className="text-5xl font-serif tracking-wider mb-4 leading-tight">
          DISCOVER <br /> TRUE QUALITY
        </h2>

        <p className="text-xs uppercase text-yellow-700 tracking-[0.3em] mb-4 flex items-center gap-4">
          Handcrafted Suit
          <span className="block w-24 h-[1px] bg-yellow-300"></span>
        </p>
